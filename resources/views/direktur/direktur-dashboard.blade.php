@extends('direktur.layouts.base-direktur', ['title' => 'Dashboard'])
    ...
    <div class="container-fluid">
        ...
        @if ($direktur === null || $direktur->alamat === null)
            <div class="alert alert-danger">
                Harap melengkapi profil anda, <a href="{{ route('direktur.profil') }}" class="btn btn-danger">Lengkapi Profil</a>
            </div>
        @endif
        <!--  Row 1 -->
        <div class="row">

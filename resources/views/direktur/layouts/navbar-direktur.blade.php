                ...
                <li class="nav-item">
                    <div class="dropdown ms-5">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationDropdown"
                            style="max-width: 400px; background-color: #e8e8e8">
                            <li>
                                ...
                                @else
                                    @foreach ($notifikasi as $item)
                                        <a class="dropdown-item"
                                            href="{{ route('direktur.baca.notifikasi', $item->id_notifikasi) }}">
                                            <div class="d-flex justify-content-between">
                                                <div>
                            ...
                            <li><a class="dropdown-item text-center text-primary"
                                    href="{{ route('direktur.notifikasi') }}">Lihat semua</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <div class="message-body">
                            <a href="{{ route('direktur.profil') }}"
                                class="{{ 'direktur/profil' == request()->path() ? 'active' : '' }} {{ 'direktur/edit-profil' == request()->path() ? 'active' : '' }} d-flex align-items-center gap-2 dropdown-item">
                            ...
                            <div class="darkmode">
                                <p class="mb-0 fs-3">Mode Gelap</p>
